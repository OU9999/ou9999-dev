  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "mineral-frame":
          "linear-gradient(145deg, rgb(255 255 255 / 0.05), rgb(232 236 236 / 0.035) 44%, rgb(255 255 255 / 0.018))",
      },
      fontFamily: {
      ...
      typography: {
        google: {
          css: {
            ...
            "--tw-prose-links": "#E8ECEC",
            "--tw-prose-bold": "#E8ECEC",
            "--tw-prose-counters": "#8B9290",
            "--tw-prose-bullets": "#8B9290",
            "--tw-prose-hr": "rgba(232, 236, 236, 0.18)",
            "--tw-prose-quotes": "#E8ECEC",
            "--tw-prose-quote-borders": "rgba(232, 236, 236, 0.28)",
            "--tw-prose-captions": "#8B9290",
            "--tw-prose-code": "#D0D7D7",
            "--tw-prose-pre-code": "#E8ECEC",
            "--tw-prose-pre-bg": "rgba(232, 236, 236, 0.035)",
            "--tw-prose-th-borders": "rgba(232, 236, 236, 0.18)",
            "--tw-prose-td-borders": "rgba(232, 236, 236, 0.14)",
          },
        },
        quoteless: {
          css: {
