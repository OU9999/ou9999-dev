...
const Tag = ({ tag }: ITagProps) => {
  return (
    <p className="cursor-pointer text-gradient-end hover:underline">{tag}</p>
  );
};
...
const PostBox = () => {
  return (
    <>
      <div className="w-full flex-col rounded-lg p-5 bg-content-header">
        ...
        <div className="w-full mt-14 text-gray-300">
          <p>2023년 7월 16일</p>
        </div>
      </div>
    </>
