...
| Blue Steel 그라데이션 스톱 | `google-blue`, `mineral-blue` | `#A2ADB3` |
| 워시 그림자 | `mineral-teal` | `#1F2A28` |
| 차가운 깊이 | `mineral-indigo` | `#202632` |

- `google-blue`, `mineral-blue`: 이미지와 등록된 그라데이션 전용
- `mineral-teal`, `mineral-indigo`: 저농도 배경 그라데이션 전용
...
- Blue Steel 허용: 대표 이미지·MDX 이미지·등록된 텍스트 그라데이션·저농도 배경 워시
